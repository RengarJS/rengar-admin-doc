...
features:
  ...
  - title: 维护积极
    details: bug修复速度快，积极维护，不烂尾，有问题随时交流
  - title: 生产环境验证
    details: 真实的后端部署（非mock接口），提供开源的后端，经过生产环境验证，确保稳定性和性能
  - title: 优雅的设计
    details: 基于 Naive UI 精心打造，界面简洁美观，完美适配暗黑模式，代码简单易懂，无过度封装
  - title: 先进技术栈
    details: 采用 Vue 3.5 + Vite 7 + TypeScript + Naive UI + Pinia + UnoCSS 等前沿技术
  - title: 智能路由
    details: 创新的文件系统路由，根据目录结构自动生成路由配置，适配vue-router类型化路由
  - title: 页面缓存增强
